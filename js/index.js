...
// const jovenes = (clientes.edad < 40) 
// ? console.log("jovenes")
// : console.log("no tan jovenes")
...
// Spread
const clientesZN = ["RAMOS JOSEFINA","MIRAFLORES LAURA","CARBALLO JULIO", "ZONDA ARTURO","SOSA ISMAEL"]

const clientesZS = ["ALCIBAR RUBEN","CASSIERRA FERNANDA","CORREA AUGUSTO", "BELTRAN MARIA","CECCINI HUGO"]

const clientesZO = ["COROMINAS AYLEN","CORONA CINTHIA","SAMPAYO TOBIAS", "SEPULBEDA MARINA","ALMEYDA RUBEN"]

const clientesZE= ["BRITO FABIAN","ORTEGA YANINA","COPPETTI BRAIAN", "MALNATTI ESTEBAN","JARAMILLO YESABEL"]

const clientesCABA= ["MIRNES OCTAVIO","MORIATTI ALEJANDRA","DE PALMA FRANCIS", "FIGUEROA VERONICA","GUALTIERI PAMELA"]

const clientesTotal= [...clientesCABA,...clientesZE,...clientesZN, ...clientesZO, ...clientesZS]

console.log("Listado de clientes: " + "\n" + clientesTotal)

const desicion= (clientesTotal.lenght < 15) ? console.log("Pocos clientes") : console.log("Muchos clientes")
